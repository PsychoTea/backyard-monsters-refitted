package
{
   ...
   public class MAP
   {
      ...
      {
         if(!_instance || !_instance._presentationTimer) GLOBAL._ROOT.stage.invalidate();
         else _instance._presentationStarted = true;
      }
      ...
      private function present(event:TimerEvent) : void
      {
         ...
         if(!this._presentationStarted || !_inited || !_GROUND || GLOBAL.isHalted || BASE._loading || MapRoomManager.instance.isOpen) return;
